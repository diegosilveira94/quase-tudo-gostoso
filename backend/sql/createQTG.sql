...
('Bolo de Chocolate Simples', 'Um delicioso bolo de chocolate fofinho e fácil de fazer, perfeito para o café da tarde.', 1, 1, 1, 1),
('Macarrão ao Molho de Tomate', 'Receita clássica de macarrão com molho de tomate caseiro.', 2, 2, 1, 1),
('Bife Grelhado', 'Bife suculento grelhado no ponto, acompanhado de legumes.', 3, 3, 2, 2);

-- Relacionar receitas com categorias
INSERT INTO `categoria_receita` (`receita_idreceita`, `categoria_idcategoria`) VALUES
(1, 1), -- Bolo de Chocolate -> Doces
(1, 7), -- Bolo de Chocolate -> Sobremesas
(2, 4), -- Macarrão -> Massas
(3, 5); -- Bife -> Carnes

-- Relacionar receitas com refeições
INSERT INTO `refeicao_receita` (`receita_idreceita`, `refeicao_idrefeicao`) VALUES
(1, 4), -- Bolo -> Lanche da Tarde
(2, 2), -- Macarrão -> Almoço
(2, 3), -- Macarrão -> Jantar
(3, 2); -- Bife -> Almoço
